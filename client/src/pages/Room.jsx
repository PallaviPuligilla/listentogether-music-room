...
export default function Room() {
  ...
  useEffect(() => {
    ...
    socket.on('songAdded', ({ song, playlist }) => {
      setPlaylist(playlist);
      addActivity('🎵', `${song.uploader} added "${song.name}"`);
    ...
    <div className="flex flex-col" style={{ minHeight: '100vh', background: '#f5f3ff' }}>
      ...
      <nav className="room-nav">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleLeave} className="nav-leave-btn">Leave</button>
        </div>
      </nav>
      ...
      <div className="mobile-tabs">
        ...
        <button className={mobileTab === 'playlist' ? 'active' : ''} onClick={() => setMobileTab('playlist')}>
      ...
      <div className="room-body">
        ...
        {/* ✅ CENTER PANEL — Single, clean, no duplicates */}
